          ...
          <div className="gi-pro-content">
            ...
            <div className="gi-pro-rat-price">
              ...
              <span className="gi-price">
                <span className="new-price">{data.newPrice}Fcfa</span>
                <span className="old-price">{data.oldPrice}Fcfa</span>
              </span>
            </div>
          </div>
        </div>
